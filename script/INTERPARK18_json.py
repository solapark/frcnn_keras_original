...
csv_path = '/data3/sap/frcnn_keras_original/data/INTERPARK18/result_file_pattern.csv'
img_dir = '/data1/sap/interpark_data/mv/train'
label_dir = '/data1/sap/interpark_data/mv/train'
json_base_path = '/data3/sap/frcnn_keras_original/data/INTERPARK18/'
#cls_list = ['myzzo', 'tunacan']
cls_list = ['seagram', 'pebriz', 'boxtape', 'cass', 'detergent', 'kantata', 'kechap', 'myzzo', 'papercup', 'parisredbean', 'pringles', 'sausage', 'seoulmilk', 'shrimpsnack', 'sunuporange', 'tunacan', 'vita500', 'vitajelly']
               
all_json_path = os.path.join(json_base_path, 'train.json')
...
train_json_path = os.path.join(json_base_path, 'train.json')
