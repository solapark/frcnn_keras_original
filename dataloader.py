...
class DATALOADER :
    ...
    def get_instance_list(self, dataset_path, json, width, height, resized_width, resized_height):
        ...
        is_class_minus_one = (self.args.dataset == 'MESSYTABLE' and filename in ['train.json', 'val.json', 'test.json', 'test_easy.json', 'test_medium.json', 'test_hard.json', 'gt+asnet+majority+nms.json', 'gt+triplenet+majority+nms.json']) 
